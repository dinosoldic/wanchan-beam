...
function getBoxWidth(box: LiveDetectionBox): number {
  "worklet";
  return box.x2 - box.x1;
}

function getBoxHeight(box: LiveDetectionBox): number {
  "worklet";
  return box.y2 - box.y1;
}

function getBoxArea(box: LiveDetectionBox): number {
  "worklet";
...
export function suppressDuplicateDetections(
  ...
  const keptDetections: LiveDogDetection[] = [];
